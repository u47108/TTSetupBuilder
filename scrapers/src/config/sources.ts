...
export const SOURCE_CONFIGS: readonly SourceConfig[] = [
  ...
  },
  {
    ...
    role: 'reviews',
    selectorNotes: [
      'Site: tabletennis-reviews.com — NOT tabletennis-reference.com',
  ...
  {
    id: 'tabletennis-reference-rubbers',
    name: 'Tabletennis Reference — rubbers',
    listingUrl: 'https://tabletennis-reference.com/rubber',
    categories: ['rubber'],
    role: 'catalog-photos-secondary',
    selectorNotes: [
      'Site: tabletennis-reference.com — NOT tabletennis-reviews.com',
      'Secondary catalog photos + community reviews/ratings; keep discontinued (stock ≠ catalog).',
      'Home: https://tabletennis-reference.com/ — PDPs: /rubber/detail/{id}',
      'LIVE: explicit PDP seeds only (e.g. detail/439). Multi-page /rubber crawl TODO.',
      'Image selector: img[src*="/images/rubber/"] prefer *_450.jpg; UA + rate limit.',
      'Naming caveat: detail/439 titled “Bruce T1 [Discontinued]” but packaging/ITTF = Blues T1 (21-043).',
      'Parse `[Discontinued]` from PDP h2 / schema.org Offer → catalog `discontinued: true` at ingest (name stripped of marker).',
      'Batch only (ADR-008/009/014). Operators must check robots.txt + ToS before live crawl.',
    ],
    rateLimitMs: 2000,
  },
  {
    id: 'tabletennis-reference-rackets',
    name: 'Tabletennis Reference — rackets',
    listingUrl: 'https://tabletennis-reference.com/racket',
    categories: ['blade'],
    role: 'catalog-photos-secondary',
    selectorNotes: [
      'Site: tabletennis-reference.com — NOT tabletennis-reviews.com',
      'Secondary catalog photos + community reviews; keep discontinued blades.',
      'Home: https://tabletennis-reference.com/ — PDPs: /racket/detail/{id}',
      'LIVE: explicit PDP seeds (e.g. Ai Fukuhara PRO ZLF detail/226 [Discontinued], Viscaria detail/858). Multi-page /racket crawl TODO.',
      'Parse `[Discontinued]` from PDP h2 / schema.org Offer availability → catalog `discontinued: true` (name stripped of marker).',
      'Batch only (ADR-008/009/014). Operators must check robots.txt + ToS before live crawl.',
    ],
    rateLimitMs: 2000,
  },
